...
const {signup, login, logout, forgotPassword, resetPassword, userdashboard, changePassword, updateUserDetail, adminAllUsers, managerAllUsers, adminSingleUser, adminUpdateSingleUser, adminDeleteSingleUser} = require('../controllers/userController')
